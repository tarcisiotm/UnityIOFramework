...
namespace IO{
    public static class IOManager {
        ...
        /// </summary>
        public static bool SaveFile (string fileName, string fileToSave, bool overwrite = true, bool encrypt = false)
        {
        ...
        public static bool SaveFile (string fileName, string fileToSave, string directory, bool overwrite = true, bool encrypt = false)
        { 
        ...
        public static bool LoadFile (string fileName, out string output, Action<string> p_action = null, bool decrypt = false)
        {
            return LoadFile (fileName, out output, "", p_action, decrypt);
        }
        ...
        public static bool LoadFile (string fileName, out string output, string directory, Action<string> p_action = null, bool decrypt = false)
        {
        ...
        public static bool SaveBytesToFile (string fileName, string fileToSave, bool overwrite = true, bool encrypt = true)
        {
        ...
        /// <param name="overwrite">If set to <c>true</c> overwrites existing files.</param>
        /// <param name="encrypt">If set to <c>true</c> encrypts.</param>
        public static bool SaveBytesToFile (string fileName, string fileToSave, string directory, bool overwrite = true, bool encrypt = true)
        { 
            CheckCreateDirectory (directory);
        ...
        /// <param name="output">Output string.</param>
        /// <param name="decrypt">If set to <c>true</c> decrypts the file.</param>
        public static bool LoadBinaryFile (string fileName, out string output, bool decrypt = true)
        {
        ...
        /// <param name="decrypt">If set to <c>true</c> decrypts the file.</param>
        public static bool LoadBinaryFile (string nameOfFile, out string output, string directory, bool decrypt = true)
        {
            if (!DirectoryExists (directory)) {
